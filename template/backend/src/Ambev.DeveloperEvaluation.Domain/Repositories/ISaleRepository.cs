...
public interface ISaleRepository
{
    ...
    Task<IEnumerable<Sale>> GetAllAsync(int page = 1, int size = 10, string order = "asc", Dictionary<string, string>? filters = null, CancellationToken cancellationToken = default);
